...
VALUES (1,'$_POST[state_name]','$_POST[location_name]','$_POST[tag_name]','$_POST[lat]','$log=$_POST[log]')");

if($tag2_name)
mysqli_query($con,"INSERT INTO FILTER (uid, state, Aname , tag, x, y)
VALUES (1,'$_POST[state_name]','$_POST[location_name]','$_POST[tag2_name]','$_POST[lat]','$log=$_POST[log]')");

if($tag3_name)
mysqli_query($con,"INSERT INTO FILTER (uid, state, Aname , tag, x, y)
VALUES (1,'$_POST[state_name]','$_POST[location_name]','$_POST[tag3_name]','$_POST[lat]','$log=$_POST[log]')");

if($location2_name)
{
	mysqli_query($con,"INSERT INTO FILTER (uid, state, Aname , tag, x, y)
	VALUES (1,'$_POST[state_name]','$_POST[location2_name]','$_POST[tag_name]','$_POST[lat]','$log=$_POST[log]')");

	if($tag2_name)
	mysqli_query($con,"INSERT INTO FILTER (uid, state, Aname , tag, x, y)
	VALUES (1,'$_POST[state_name]','$_POST[location2_name]','$_POST[tag2_name]','$_POST[lat]','$log=$_POST[log]')");

	if($tag3_name)
	mysqli_query($con,"INSERT INTO FILTER (uid, state, Aname , tag, x, y)
	VALUES (1,'$_POST[state_name]','$_POST[location2_name]','$_POST[tag3_name]','$_POST[lat]','$log=$_POST[log]')");
